...
object Boot extends App {
  ...
  modules.widgetDal.insert(Widget(0, 1, 3, "test2", "test2", "insert", "i", false, true, "2017-03-03 12:00:00", 1, "2017-03-03 12:00:00", 1))
  ...
  modules.relDashboardWidgetDal.insert(RelDashboardWidget(0, 1, 2, 10, 10, 10, 10, true, "2017-03-03 12:00:00", 1, "2017-03-03 12:00:00", 1))
  modules.relDashboardWidgetDal.insert(RelDashboardWidget(0, 1, 3, 10, 10, 10, 10, true, "2017-03-03 12:00:00", 1, "2017-03-03 12:00:00", 1))
  ...
  modules.relGroupBizlogicDal.insert(RelGroupBizlogic(0, 1, 1, "test", true, "2016-11-24 11:11:11", 1, "2016-11-24 11:12:12", 1))
  modules.relGroupBizlogicDal.insert(RelGroupBizlogic(0, 1, 2, "test", true, "2016-11-24 11:11:11", 1, "2016-11-24 11:12:12", 1))
  modules.relGroupBizlogicDal.insert(RelGroupBizlogic(0, 2, 3, "test", true, "2016-11-24 11:11:11", 1, "2016-11-24 11:12:12", 1))
