...
case class SimpleSource(domain_id: Long,
                        group_id: Long,
                        name: String,
                        desc: String,
                        `type`: String,
...
//  def name = column[String]("name")
  ...
  def * = (id, domain_id, group_id, name, desc, `type`, config, active, create_time, create_by, update_time, update_by) <> (Source.tupled, Source.unapply)
}
